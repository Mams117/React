                            ...
                            <div className="modal-dialog">
                                <div className="modal-content">
                                    <div className="modal-header">
                                        <h1 className="modal-title fs-5" id="exampleModalLabel">Ingreso al Sistema</h1>
                                    ...
                                    <div className="modal-body">
                                        <form>
                                            ...
                                            <div className="mb-3">
                                                <p><a className="link-opacity-100" href="#">No estoy registrado en el
                                                        sistema !</a></p>
                                            </div>
                                    ...
                                    <div className="modal-footer">
                                        ...
                                        <button type="button" className="btn btn-primary" id="btnEnviar">Enviar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
